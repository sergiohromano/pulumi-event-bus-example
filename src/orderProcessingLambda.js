...
exports.handler = async (event) => {
    console.log('Order Processing Lambda received event:', JSON.stringify(event, null, 2));
    ...
    console.log('Order processed. Payment details:', JSON.stringify(paymentDetail, null, 2));
